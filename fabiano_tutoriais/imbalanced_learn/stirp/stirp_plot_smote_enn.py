...
txt_file_name = "smote.enn_" + date_time_str + "_info.txt"
output_csv_file_name = "smote.enn_" + date_time_str + "_resampled.csv"
...
print "SMOTE+ENN resampling task started..."
output_text_file.write("SMOTE+ENN resampling task started...\n")
t_resampling_start = time()
X_resampled, y_resampled = sm.fit_sample(X, y)
t_resampling_end = round(time()-t_resampling_start, 3)
print "SMOTE+ENN resampling task took:", t_resampling_end, "s"
output_text_file.write("SMOTE+ENN resampling task took:" + str(t_resampling_end) + "s\n\n")
print
