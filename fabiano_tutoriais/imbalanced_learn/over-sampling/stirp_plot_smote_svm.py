"""
=========================================================================
SVM SMOTE Over-sampling Method applied to real financial transactions
=========================================================================
An illustration of the SVM SMOTE  method applied 
...
txt_file_name = "resampling_svm_smote_" + date_time_str + ".txt"
output_csv_file_name = "svm_smote_transactions_resampled_" + date_time_str + ".csv"
...
print "SVM SMOTE resampling task started..."
output_text_file.write("SVM SMOTE resampling task started...\n")
t_resampling_start = time()
X_resampled, y_resampled = smote.fit_sample(X, y)
t_resampling_end = round(time()-t_resampling_start, 3)
print "SVM SMOTE resampling task took:", t_resampling_end, "s"
output_text_file.write("SVM SMOTE resampling task took:" + str(t_resampling_end) + "s\n\n")
print
